    ...
    <div class="box-body">
        <div class="feed-item-head row mt-20 m-width-20">
            <div class="feed-item-head-photo">
                <a href="<?=$base;?>/profile.php?id=<?=$item->user->id;?>"><img src="media/avatars/<?=$item->user->avatar;?>" /></a>
            </div>
            ...
            <div class="feed-item-head-btn">
                ...
                <div class="feed-item-more-window">
                    <a href="<?=$base;?>/delete_post_action.php?id=<?=$item->id;?>">Delete This Post</a>
                </div>
            </div>
            <?php endif; ?>
        </div>
        ...
        <div class="feed-item-comments">
                ...
                <?php foreach($item->comments as $comment): ?>
                    ...
                    <div class="fic-item row m-height-10 m-width-20">
                        <div class="fic-item-photo">
                            <a href="<?=$base;?>/profile.php?id=<?=$comment->id_user;?>"><img src="<?=$base;?>/media/avatars/<?=$comment->user->avatar;?>" /></a>
                        </div>
            ...
            <div class="fic-answer row m-height-10 m-width-20">
                ...
                <input type="text" class="fic-item-field" placeholder="Write a comment" />
            </div>
